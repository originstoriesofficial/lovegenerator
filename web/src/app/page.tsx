          ...
          <div className="relative bg-black overflow-hidden border border-neon-green hover:border-neon-green-light transition-all">
            ...
            <div className="relative z-20">
              <div className="pt-8 pb-6 px-8 text-center">
                <h2 className="text-3xl font-bold mb-4 text-neon-green tracking-widest">
                  Dance Floor VJ
                </h2>
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="relative top-0 h-auto justify-center flex bg-gradient-to-r border-neon-green/20 items-center from-blue-500 via-teal-500 to-pink-500 bg-clip-text text-6xl font-extrabold text-transparent text-center select-auto">
                    Enter Dance Floor
                  </span>
                </div>
              </div>
